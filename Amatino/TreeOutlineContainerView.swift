...
class TreeOutlineContainerView: NSViewController {
    ...
    let board = NSStoryboard(name: NSStoryboard.Name(rawValue: "Entity"), bundle: nil)
    ...
    override func viewDidLoad() {
        ...
        let loadingView = board.instantiateController(withIdentifier: entityLoadScene) as! NSViewController
